            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-10 border border-gray-100 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-black mb-2 text-gray-900 tracking-tight">Kayıt Olun</h1>
                        <p className="text-gray-500 font-medium">
                            Profesyonel imzanızı saniyeler içinde oluşturun
                        </p>
                    </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-100 text-center">
                        <p className="text-gray-500 font-medium text-sm">
                            ...
                            <Link href="/login" className="text-forest font-bold hover:underline ml-1">
                                Giriş Yap
                            </Link>
                        </p>
                    </div>
