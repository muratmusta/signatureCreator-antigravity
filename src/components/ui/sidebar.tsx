...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
    ...
    // Auto-open sidebar only when transitioning from mobile to desktop
        ...
        <>
            {isMobile ? (
                ...
                >
                    <div
                        className={cn(
                            "sticky top-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-300 ease-in-out md:flex",
                            side === "left"
    ...
    return (
        <main
            ...
            className={cn(
                ...
                "md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[state=expanded]:peer-data-[variant=inset]:ml-0",
